...
<header class="header-v4">
                ...
                <div class="wrap-icon-header flex-w flex-r-m">
                    <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 js-show-modal-search">
                        ...
                        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart" data-notify=" 
                            <?php
                                if (!is_null(Cookie::get('basket')) and !empty(Cookie::get('basket'))) {
                                    echo count(json_decode(Cookie::get('basket') , true)) ;
                                }else {
                                    echo "0";
                                }
                            ?>
    ...
    <div class="modal-search-header flex-c-m trans-04 js-hide-modal-search">
        <div class="container-search-header">
            ...
            <form class="wrap-search-header flex-w p-l-15" action="{{ route('home.index') }}">
        ...
        <div class="header-cart-content flex-w js-pscroll">
            ...
            <div class="w-full">
                <div class="header-cart-total w-full p-tb-40">
                    <?php
                        if(!is_null(Cookie::get('basket')) and !empty(Cookie::get('basket'))) {
                            $total = array_sum(array_column(json_decode(Cookie::get('basket'), true), 'price'));
                            echo "جمع کل : " . $total . " هزار تومان ";
                        }
                    ?>
                </div>
