                          ...
                          <div class="card-body">
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      ...
                                      <img src="/{{ $product->thumbnail_url }}" width="100px" height="100px">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          <label>تصویر محصول</label>
                                          <input class="form-control" type="file" name="demo_url" value="{{ $product->demo_url }}">
                                      </div>
                                      <img src="/{{ $product->demo_url }}" width="100px" height="100px">
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
